...
namespace System.Maui.Internal.Reload
{
    public partial class Evaluator
    {
        ...
        Type _viewType;
        Type _handlerType;
        Type ViewType => _viewType ?? (_viewType = CometAssembly?.GetType("System.Maui.View"));
        Type HandlerType => _handlerType ?? (_handlerType = CometAssembly?.GetType("System.Maui.IViewHandler"));
